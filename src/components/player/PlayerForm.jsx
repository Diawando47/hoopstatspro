...
export default function PlayerForm() {
  ...
  const [form, setForm] = useState({ name: '', number: '', pos: 'PG', team: 'Bulls FC' })
    ...
    <>
      ...
      <div className="form-grid">
        <div className="form-group full">
          ...
          <input value={form.name} onChange={e => set('name', e.target.value)} placeholder="Prénom Nom" autoFocus />
        </div>
        <div className="form-group">
          <label>Numéro</label>
          <input type="number" value={form.number} onChange={e => set('number', e.target.value)} placeholder="23" min="0" max="99" />
        </div>
        <div className="form-group">
